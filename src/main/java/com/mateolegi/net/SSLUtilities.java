...
public final class SSLUtilities {
     ...
     * trust all hostnames.
     */
    public static void trustAllHostnames() { _trustAllHostnames(); } // trustAllHostnames

    /**
     * Set the default X509 Trust Manager to an instance of a fake class that
     * trust all certificates, even the self-signed ones.
     */
    public static void trustAllHttpsCertificates() { _trustAllHttpsCertificates(); } // trustAllHttpsCertificates
    ...
    public static class FakeHostnameVerifier implements HostnameVerifier {
         ...
         */
        public boolean verify(String hostname, javax.net.ssl.SSLSession session) { return (true); } // verify
    ...
    public static class FakeX509TrustManager implements X509TrustManager {
         ...
         */
        public X509Certificate[] getAcceptedIssuers() { return (_AcceptedIssuers); } // getAcceptedIssuers
